#
# Module manifest for module 'WebAdministrationDSC.Reverse'
#
...
@{
    ...
    GUID              = 'f58213dc-a9f0-49fb-9428-a31938031a77'
    ...
    Description       = 'This DSC module is used to extract the IIS configuration as DSCon a given server.'
    ...
    #RequiredModules = @(@{ModuleName = "ReverseDSC"; ModuleVersion = "1.9.4.5"; },
    #                    @{ModuleName = "WebAdministrationDSC"; ModuleVersion = "2.7.0.0"; })
    ...
    CmdletsToExport   = 'Export-WebAdministrationDSC'
